...
public class BuyBitcoinActivity extends AppCompatActivity implements PayAdapter.PayAdapterCallback {
    ...
    private void init() {
        ...
        payModels.add(PayAdapter.PayModel.createBitcoin("https://exmo.me/?ref=942382",
                getString(R.string.exmo_title),
                getString(R.string.exmo_title_descr),
                getString(R.string.str_goto),
                R.drawable.exmo));

        payModels.add(PayAdapter.PayModel.createBitcoin("https://www.binance.com/?ref=29220667",
                getString(R.string.binance_title),
                getString(R.string.binance_title_descr),
                getString(R.string.str_goto),
                R.drawable.binance));

        payModels.add(PayAdapter.PayModel.createBitcoin("https://yobit.io/?bonus=JlKcT",
