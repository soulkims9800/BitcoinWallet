...
import serverconfig.great.app.serverconfig.helper.VersionUpdater;
...
import wallet.bitcoin.bitcoinwallet.fragment.DemoFirstItem;
...
public class MainActivity extends AppCompatActivity implements BottomMenuControl.MenuCallback {
    ...
    private void init(){
        ...
        VersionUpdater.check(this, AwsApp.getServerConfig().getLatestVersionOnGP(), App.getContext().getResources().getString(R.string.wallet_name));
    }
